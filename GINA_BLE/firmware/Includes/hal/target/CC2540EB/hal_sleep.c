/*******************************************************************************
  ...
  Revised:        $Date: 2011-12-16 14:33:30 -0800 (Fri, 16 Dec 2011) $
  Revision:       $Revision: 28697 $
...
HAL_ISR_FUNCTION(halSleepTimerIsr, ST_VECTOR)
{
  ...
  // CC2540 chip bug workaround. T2 overflow compare 1 interrupt is generated
  // only for "=" but not for ">" condition.
