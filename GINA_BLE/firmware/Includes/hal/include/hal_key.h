...
#define HAL_KEY_SW_1 0x40  // Joystick up
#define HAL_KEY_SW_2 0x20  // Joystick right
#define HAL_KEY_SW_5 0x08  // Joystick center
#define HAL_KEY_SW_4 0x10  // Joystick left
#define HAL_KEY_SW_3 0x80  // Joystick down
#else
