...
CONST uint8 hidReportRefUUID[ATT_BT_UUID_SIZE] =
{
  LO_UINT16(HID_REPORT_REF_UUID), HI_UINT16(HID_REPORT_REF_UUID)
};

// HID External Report Reference Descriptor
CONST uint8 hidExtReportRefUUID[ATT_BT_UUID_SIZE] =
{
  LO_UINT16(HID_EXT_REPORT_REF_UUID), HI_UINT16(HID_EXT_REPORT_REF_UUID)
};
/*********************************************************************
 * GLOBAL FUNCTIONS
 */
